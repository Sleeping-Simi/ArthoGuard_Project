...
class _DashboardPageState extends State<DashboardPage> {
  ...
  void _openAiScan() {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => RomGuideScreen(
  ...
  void _openAssessmentTest() {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => KneeAssessmentScreen(
          userData: widget.userData,
        ),
      ),
    );
  ...
  // ============================================================
  // SMART THERAPY CONTROL
  // ============================================================

  void _toggleVibrationMode(
    int mode,
    bool isOn,
  ) {
    setState(() {
  ...
  void _logTherapySession() {
    ...
    final duration =
        DateTime.now().difference(_modeStartTime!);
    ...
    final String modeName =
        activeMode == 1
            ? "Mode 1: Gentle Recovery"
            : activeMode == 2
                ? "Mode 2: Moderate Stimulation"
                : "Mode 3: Deep Tissue Rehab";
  ...
  void _showProfileDetails() {
    ...
    final String name = _textValue(
      wData['patientName'] ??
          wData['name'],
      fallback: "Patient",
    );

    final String email = _textValue(
      wData['email'],
      fallback: "N/A",
    );

    final String age = _textValue(
      wData['age'],
      fallback: "N/A",
    );

    final String gender = _textValue(
      wData['gender'],
      fallback: "N/A",
    );

    final String height = _textValue(
      wData['height'],
      fallback: "N/A",
    );

    final String weight = _textValue(
      wData['weight'],
      fallback: "N/A",
    );

    final String bmi = _textValue(
      wData['bmi'],
      fallback: "N/A",
    );

    final String bmiCategory = _textValue(
      wData['bmiCategory'],
      fallback: "N/A",
    );

    final String pain = _textValue(
      wData['painLevel'],
      fallback: "0",
    );

    final String diagnosis = _textValue(
      wData['arthritis'],
      fallback: "N/A",
    );
                              ...
                              const Expanded(
                                child:
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      "Capture your knee and identify "
